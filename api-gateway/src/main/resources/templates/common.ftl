...
<head>
    ...
    <link rel="stylesheet" href="/static/assets/bootstrap/css/new.css"type="text/css">
...
<aside id="featured-properties">
    ...
    <div class="property small">
        ...
        <div class="info">
            <a href="/house/detail?id=${(project.id)!}"><h4>${(project.name)!}</h4></a>
            <figure>${(project.address)!} </figure>
            <div class="tag price">￥${(project.price)!} 万</div>
        </div>
    </div><!-- /.property -->
    </#list>
...
<aside id="edit-search">
    ...
    <form role="form" id="_searchForm" class="form-search" method="post" action="/project/list">
     ...
     <div class="secondary-navigation">
         <div class="container">
             ...
             <div class="user-area">
                 <div class="actions">
                    <#if (loginUser.name)??>
                        <a href="/accounts/profile" class="promoted">你好，陈晓跃</a>
                          <#if (loginUser.email)?? && (loginUser.email) == "1305499592@qq.com">
                          <a href="/agency/create" class="promoted">创建公司机构</a>
                          </#if>
         ...
         <header class="navbar" id="top" role="banner">
             <div class="navbar-header">
                 ...
                 <div class="navbar-brand nav" id="brand">
                     <a href="/"><img src="/static/assets/img/schoollogo.png" alt="brand"></a>
                 </div>
             </div>
             <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                 <ul class="nav navbar-nav">
                     <li><a href="/index">首页</a></li>
                     <li class="has-child"><a href="/project/list">项目</a>
                         <ul class="child-navigation">
                             <li><a href="/project/list?type=1">上市公司</a></li>
                             <li><a href="/project/list?type=2">国企</a></li>
                             <li><a href="/project/list?type=3">私人公司</a></li>
                         </ul>
                     </li>
                     <li class="has-child"><a href="#">人事</a>
                         <ul class="child-navigation">
                             <li><a href="/agency/agentList">人事列表</a></li>
                             <li><a href="/agency/list">公司列表</a></li>
                         </ul>
                     </li>
                     <li><a href="/community">论坛</a></li>
                 </ul>
             ...
             <div class="add-your-property">
                 <a href="/project/toAdd" class="btn btn-default"><i class="fa fa-plus"></i><span class="text">添加项目</span></a>
             </div>
         </header><!-- /.navbar -->
     </div><!-- /.container -->
 </div>
